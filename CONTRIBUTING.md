...
3. Make your changes
4. Test by running `bash tests/stop-hook.test.sh`, `bash tests/codex-driver.test.sh`, `bash tests/docs-integrity.test.sh`, `./install.sh`, `./install-codex.sh`, and using the driver and status commands in a real project
